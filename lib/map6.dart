...
//       10.5881, 77.2489); // Default coordinates for Udumalaipet
//
...
//       15, (index) => TextEditingController());
...
//
//     String url =
//         'https://router.project-osrm.org/route/v1/driving/${startLocation
//         .longitude},${startLocation
//         .latitude};$waypoints?overview=full&geometries=geojson';
//
//     try {
...
//       totalDistance +=
//           _calculateDistance(routeCoordinates[i], routeCoordinates[i + 1]);
//     }
//   }
//
...
//     List<String> routeData = routeCoordinates.map((latLng) =>
//         jsonEncode({'lat': latLng.latitude, 'lng': latLng.longitude})).toList();
...
//       try {
//         LatLng? newStartLocation = await _getLatLngFromAddress(
...
//                                           ElevatedButton(
//                                             onPressed: () async {
//                                               LatLng? newLatLng = await _getLatLngFromAddress(
//                                                   _controllers[i].text);
...
//               children: [
//                 Text(
//                   'Total Distance: ${(totalDistance / 1000).toStringAsFixed(
//                       2)} km',
...
// }
//
// ///No starting location but loading selected location editable
